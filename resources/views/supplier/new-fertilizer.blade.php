    ...
    <x-slot name="header">
        ...
        <div class="flex justify-center  my-5  ">
            <div class="flex flex-col items-center bg-white rounded-lg shadow-xl px-12 py-7   ">
                <form action="{{ route('sup-fertilizer.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="container mx-auto">
                        <div class="flex flex-col space-y-4">
                            ...
                            <button type="submit" class="bg-blue-500 text-white px-12 py-2 rounded mx-auto">Add</button>
                        </div>
                    </div>
                </form>
